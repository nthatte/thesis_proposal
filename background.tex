...
\subsubsection{Neuromuscular Models with CPGs}
...
\subsection{Reflexes}
\subsubsection{Reflexes in biology}
...
\subsubsection{Neuromuscular Models with Muscular Reflexes}
\begin{marginfigure}
    \centering
    \includegraphics[height=5.5in]{reflex_diagram} 
    \caption{Neuromuscular models with muscular reflex feedbacks. The model
    developed by \citet{ogihara2001generation} activates individual muscles
    according to the activity of a CPG and proprioceptive reflexes that can
    involve the muscle itself, other muscles, and ground contact sensing.
    \citet{geyer2010muscle} does away with the CPG and achieves locomotion with
    only reflex feedbacks.}
...
\subsubsection{Reflexes for Prosthesis Control}
\begin{marginfigure}
    \centering
...
\subsubsection{Conclusion of Controls Review} 
In summary, simulations and implementations of the neuromuscular reflex control
approach have repeated demonstrated its ability to generalize to a variety of
situations and exhibit robustness to a variety of disturbances. These two
properties make this control paradigm very attractive for application to
transfemoral prostheses due to the gait deficits and fall risk transfemoral
amputees face. In contrast, other control approaches for prostheses such as
impedance control have not demonstrated these properties. As yet, there have not
been any published works applying neuromuscular reflex control to active
knee and ankle transfemoral prostheses. Therefore, in this thesis, we work
towards goal with the hope of improving transfemoral amputee gait robustness and
naturalness.

\section{Prosthesis Design}

\subsection{Design of Walking Robots}

\subsubsection{Bipedal Robots}
\begin{description}
    \item[MIT Cheetah]
    \item[Atrias]
\end{description}

\subsection{Design of Prostheses}
