...
approaches to prosthesis optimization for individual amputees.
...
with neuromuscular reflex control, which provides a unified explanation for both
the nominal and disturbed behaviors of the human leg. With this approach, we
hope the prosthesis will be respond to smaller disturbances like biological
human leg and will be able to execute dynamic trip recovery responses such as
the raising and lowering strategies in response to larger disturbances.
