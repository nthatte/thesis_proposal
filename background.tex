...
university. The first prosthesis in this line used ball screw transmissions and
a pair of brushless motors capable of 200 W continuous power output. 
...
\begin{marginfigure}
    ...
    \label{fig:ankle_torque_v_angle}
\end{marginfigure}
...
%Vanderbilt gen 3 knee = 35 g*cm^2 * 176^2 in kg*m^2 = 0.1 kg*m^2
