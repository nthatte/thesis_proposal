...
limb. \Cref{sec:back_walking_review} provides an overview of those approaches,
their strengths, and weaknesses. \Cref{sec:back_bioinspired_pros_control} dives
deeper into bioinspired control approaches that are particularly well suited for
prosthesis control as the are capable of addressing challenges 1 and 2 of
amputee locomotion (\cref{sec:intro_challenges}). \Cref{sec:back_pros_design}


\section{Fundamental Walking Dynamics and
Control}\label{sec:back_walking_review}
\subsection{Dynamics of Human Locomotion}\label{sec:back_simple_models}
\subsubsection{Rimless wheel}
\subsubsection{Inverted Pendulum}
\subsubsection{Bipedal Spring Mass}

\subsection{Walking Controllers}\label{sec:back_walk_control}
Shaping walking Dynamics through control

\subsubsection{Kinematic Centralized
Controllers}\label{sec:back_kinematic_centralized}
...
\subsubsection{Dynamic Centralized
Controllers}\label{sec:back_dynamic_centralized} 
...
\subsubsection{Kinematic Decentralized
Controllers}\label{sec:back_kinematic_decentralized}
    \begin{itemize}
        \item echo control
    \end{itemize}
\subsubsection{Dynamic Decentralized Controllers}\label{sec:back_dynamic_decentralized}
...
\section{Stumble Recovery for Prostheses} 
