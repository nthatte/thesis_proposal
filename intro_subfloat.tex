...
\begin{marginfigure}[0.8in]
    \centering
    \subfloat[Ottobock C-Leg knee prosthesis\label{fig:ottobock_cleg}]
    {%
        %\includegraphics[width = \textwidth]{}
        \missingfigure{C-Leg}
    }

    \subfloat[Össur Rheo Knee\label{fig:ossur_rheo}]
    {%
        %\includegraphics[width = \textwidth]{}
        \missingfigure{Rheo Knee}
    }

    \subfloat[Freedom Innovations Foot\label{fig:freedom_innovations_foot}]
    {%
        %\includegraphics[width = \textwidth]{}
        \missingfigure{Foot}
    }
...
\begin{figure*}[b]
    \centering
    \subfloat[Generation 1]
    {%
        %\includegraphics[width = 0.3\textwidth]{}
        \missingfigure{Gen 1}
    }

    \subfloat[Generation 2]
    {%
        %\includegraphics[width = 0.3\textwidth]{}
        \missingfigure{Gen 2}
    }

    \subfloat[Generation 3]
    {%
        %\includegraphics[width = 0.3\textwidth]{}
        \missingfigure{Gen 3}
    }
