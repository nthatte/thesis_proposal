...
\unitfrace[3.2]{m}{s} as measured by \citet{novacheck1998biomechanics}. To
...
reduction (CSG--20--50). \Cref{fig:knee_torque_vs_angle} shows the motor torque
...
series elasticity, gear dynamics, and motor electrical dynamics\sidenote{for
...
As with the knee joint, we design the ankle joint to satisfy the requirements
