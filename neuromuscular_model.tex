...
review two versions of the swing leg contro: First, an idealized controal,
proposed in \citet{desai2012robust}, which proposes reflexes that directly apply
torques to the knee and ankle joints, and second, a muscle reflex control,
presented in \citet{desai2013muscle}, which applies neural stimulations to
Hill-type muscles to achieve the functionality of the idealzed control.
...
\begin{align}
    ...
    \label{eq:simbicon}
\end{align}
prescribes desired foot placement locations, where $\alpha_{\tn{tgt}}$ is the
